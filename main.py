...
admin_id = '6309252183'
token = "7946880982:AAEtWixQAxT9895yK1UafYjSbM7HG28t5fc"
...
def check_card(card, message):
    ...
    response = ""
    if any(keyword in result for keyword in ['PAID', 'charge','avs', 'postal', 'approved', 'Nice!', 'Approved', 'cvv: Gateway Rejected: cvv', 'does not support this type of purchase.', 'Duplicate', 'Successful', 'Authentication Required', 'successful', 'Thank you', 'confirmed', 'successfully']):
